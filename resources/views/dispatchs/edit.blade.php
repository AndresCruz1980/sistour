<div class="modal fade" id="ModalEdit{{ $dispatch->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-success pt-3 py-4 pb-3">
                <h6 class="modal-title text-white">EDITAR DESPACHO</h6>
            ...
            <div class="modal-body bg-white p-4">
                <div class="row g-3 pt-3 pb-2 col-md-12">
                    <div class="form-group mb-2 mt-2 col-md-12">
                        ...
                        <input class="form-control form-control-solid" id="litros_asignado" name="litros_asignado" type="text" required value="{{ $dispatch->litros_asignado }}" />
                    </div>
                    <div class="form-group mb-2 mt-2 col-md-12">
                    ...
                    <input class="form-control form-control-solid" id="task" name="task" type="hidden" value="actualizar" />
